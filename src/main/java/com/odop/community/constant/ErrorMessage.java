...
public class ErrorMessage {
    ...
    public static final String ERROR_ADD_POST = "Attempt to add a post = {}";
    public static final String ERROR_FIND_POST = "Attempt to find a post = {}";
    public static final String ERROR_MODIFY_POST = "Attempt to modify the post = {}";
    public static final String ERROR_DELETE_POST = "Attempt to delete the post = {}";

    public static final String ERROR_ADD_COMMENT = "Attempt to add a comment = {}";
